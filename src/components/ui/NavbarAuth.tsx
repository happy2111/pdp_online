  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="relative h-10 w-10 rounded-full p-0 overflow-hidden hover:bg-transparent focus-visible:ring-primary"
        >
      ...
      <DropdownMenuContent
        className="w-56 mt-2 rounded-2xl p-2 shadow-xl border-border/50"
        align="end"
        sideOffset={8}
      >
