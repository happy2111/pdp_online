...
const SettingsStats = (props: Props) => {
  ...
  return (
    <motion.div initial="hidden" animate="visible" custom={1}
      ...
      {[
        { label: "students", value: course.enrolled_count, icon: BookOpen },
        { label: "rating", value: course.rating_avg.toFixed(1), icon: BarChart3 },
        { label: "hours", value: course.duration_hours, icon: Play },
        { label: "price", value: course.price != null ? `${course.price} so'm` : "Бесплатно", icon: DollarSign },
